%% SHADOWING (FAIL) AROUND A QUADRATIC SADDLE (GD)
%% for shadowing, change initial conditions as in paper.
...
if d==2
    ...
    h1=plot(x(1,:),x(2,:),'o','Linewidth',2, 'MarkerFaceColor', [0.993 0.582 0.026]);hold on
